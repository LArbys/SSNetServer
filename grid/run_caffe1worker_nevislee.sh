...
SSS_BASEDIR=/home/tmw/working/ssnetserver
WORKDIR=/home/tmw/working/ssnetserver/grid
BROKER=10.246.81.73
PORT=5560
GPUIDLIST=/tmp/nevislee_gpu_assignments.txt
WORKER_OFFSET=600
PID=$1
...
source setup_caffelarbys_container_nevislee.sh
