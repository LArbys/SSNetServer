...
WORKDIR_IN_CONTAINER=/cluster/kappa/wongjiradlab/twongjirad/ssnetserver
...
singularity exec ${CONTAINER} bash -c "cd ${WORKDIR_IN_CONTAINER} && ./run_caffe1client.sh ${WORKDIR_IN_CONTAINER} ${BROKER} ${PORT} ${OUTDIR_IN_CONTAINER} ${JOBLIST} ${RUNLIST}"
